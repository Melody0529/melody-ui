...
export default {
    ...
    data() {
        return {
            ...
            mainImgOffset: 0,
            imgUrl1: require('../../assets/img/theme-index-blue.png'),
            imgUrl2: require('../../assets/img/theme-index-red.png'),
            imgUrl3: require('../../assets/img/tipe.svg'),
            imgUrl4: require('../../assets/img/duohui.svg'),
            imgUrl5: require('../../assets/img/component.png')
        }
    },
    beforeDestroy() {
