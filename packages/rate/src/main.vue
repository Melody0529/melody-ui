            ...
            <i
                ...
                :style="getIconStyle(item)">
                 <i
                    ...
                    :style="decimalStyle"
                    class="m-rate__decimal">
                </i>
            </i>
        </span>
        <span v-if="showText || showScore" class="m-rate__text" :style="{ color: textColor }">{{ text }}</span>
    </div>
</template>

<script>
import { hasClass } from 'melody-ui/src/utils/dom'
import { isObject } from 'melody-ui/src/utils/types'
...
export default {
    ...
    props: {
        ...
        iconClasses: {
            type: [Array, Object],
            default() {
                return ['m-icon-star-fill', 'm-icon-star-fill', 'm-icon-star-fill']
            }
        },
        voidIconClass: {
            type: String,
    ...
    methods: {
        ...
        setCurrentValue(value, event) {
            ...
            if (this.allowHalf) {
                ...
                if (hasClass(target, 'm-rate__item')) {
                    target = target.querySelector('.m-rate__icon')
                }
                if (hasClass(target, 'm-rate__decimal')) {
