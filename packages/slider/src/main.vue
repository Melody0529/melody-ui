<template>
    <div
        class="m-slider"
        :class="{ 'is-vertical': vertical, 'm-slider--with-input': showInput }"
        role="slider"
        :aria-valuemin="min"
        :aria-valuemax="max"
            ...
            <template v-if="markList.length > 0">
                <div>
                    <div
                        ...
                        class="m-slider__stop m-slider__marks-stop"
                        :key="key">
                    </div>
                </div>
                <div class="m-slider__marks">
                    <slider-marker
...
<script>
import MInputNumber from 'melody-ui/packages/input-number'
