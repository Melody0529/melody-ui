...
import MRadio from 'melody-ui/packages/radio'
import { isEqual } from 'melody-ui/src/utils/util'
...
export default {
    ...
    methods: {
        ...
        renderCheckIcon(h) {
            return (
                <i class="m-icon-check m-cascader-node__prefix"></i>
            )
        },

        renderLoadingIcon(h) {
            return (
                <i class="m-icon-loading m-cascader-node__postfix"></i>
            )
        },

        renderExpandIcon(h) {
            return (
                <i class="m-icon-right m-cascader-node__postfix"></i>
            )
        },
        ...
        renderContent(h) {
            ...
            return (
                <span class="m-cascader-node__label">{ vnode || node.label }</span>
            )
        }
    },
    render(h) {
