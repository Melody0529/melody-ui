<template>
    <transition
        ...
        <div
            v-show="visible"
            class="m-time-range-picker m-picker-panel m-popper"
            :class="popperClass">
            <div class="m-time-range-picker__content">
                <div class="m-time-range-picker__cell">
                    <div class="m-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
                    <div
                        :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
                        class="m-time-range-picker__body m-time-panel__content">
                        <time-spinner
                            ref="minSpinner"
                ...
                <div class="m-time-range-picker__cell">
                    <div class="m-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
                    <div
                        :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
                        class="m-time-range-picker__body m-time-panel__content">
                        <time-spinner
            ...
            <div class="m-time-panel__footer">
                <button
                    type="button"
                    class="m-time-panel__btn cancel"
                    @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
                <button
                    type="button"
                    class="m-time-panel__btn confirm"
                    @click="handleConfirm()"
