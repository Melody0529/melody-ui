<template>
    <transition name="m-zoom-in-top">
        <div
            v-show="visible"
            class="m-picker-panel m-date-picker m-popper"
            :class="[{
            ...
            <div class="m-picker-panel__body-wrapper">
                ...
                <div class="m-picker-panel__body">
                    <div class="m-date-picker__time-header" v-if="showTime">
                        <span class="m-date-picker__editor-wrap">
                            <m-input
                        ...
                        <span class="m-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
                            <m-input
                                ref="input"
                    ...
                    <div
                        class="m-date-picker__header"
                        :class="{ 'm-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
                        v-show="currentView !== 'time'">
                        <button
                            type="button"
                            @click="prevYear"
                            :aria-label="t(`el.datepicker.prevYear`)"
                            class="m-picker-panel__icon-btn m-date-picker__prev-btn m-icon-doubleleft">
                        </button>
                        <button
                            type="button"
                            @click="prevMonth"
                            ...
                            class="m-picker-panel__icon-btn m-date-picker__prev-btn m-icon-left">
                        </button>
                        <span
                            @click="showYearPicker"
                            role="button"
                            class="m-date-picker__header-label">{{ yearLabel }}</span>
                        <span
                            @click="showMonthPicker"
                            v-show="currentView === 'date'"
                            role="button"
                            class="m-date-picker__header-label"
                            :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
                        <button
                            type="button"
                            @click="nextYear"
                            :aria-label="t(`el.datepicker.nextYear`)"
                            class="m-picker-panel__icon-btn m-date-picker__next-btn m-icon-doubleright">
                        </button>
                        <button
                            type="button"
                            @click="nextMonth"
                            ...
                            class="m-picker-panel__icon-btn m-date-picker__next-btn m-icon-right">
                        </button>
                    </div>
...
export default {
    ...
    components: {
        TimePicker, YearTable, MonthTable, DateTable, MInput, MButton
    },
