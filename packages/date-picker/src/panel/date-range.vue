<template>
    <transition name="m-zoom-in-top" @after-leave="$emit('dodestroy')">
        <div
            v-show="visible"
            class="m-picker-panel m-date-range-picker m-popper"
            :class="[{
                'has-sidebar': $slots.sidebar || shortcuts,
                'has-time': showTime
            }, popperClass]">
            <div class="m-picker-panel__body-wrapper">
                <slot name="sidebar" class="m-picker-panel__sidebar"></slot>
                <div class="m-picker-panel__sidebar" v-if="shortcuts">
                    <button
                        type="button"
                        class="m-picker-panel__shortcut"
                        v-for="(shortcut, key) in shortcuts"
                        :key="key"
                        @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
                </div>
                <div class="m-picker-panel__body">
                    <div class="m-date-range-picker__time-header" v-if="showTime">
                        <span class="m-date-range-picker__editors-wrap">
                            <span class="m-date-range-picker__time-picker-wrap">
                                <m-input
                                    size="small"
                                    :disabled="rangeState.selecting"
                                    ref="minInput"
                                    :placeholder="t('el.datepicker.startDate')"
                                    class="m-date-range-picker__editor"
                                    :value="minVisibleDate"
                                    @input="val => handleDateInput(val, 'min')"
                                    @change="val => handleDateChange(val, 'min')" />
                            </span>
                            <span class="m-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                                <m-input
                                    size="small"
                                    class="m-date-range-picker__editor"
                                    :disabled="rangeState.selecting"
                        ...
                        <span class="m-date-range-picker__editors-wrap is-right">
                            <span class="m-date-range-picker__time-picker-wrap">
                                <m-input
                                    size="small"
                                    class="m-date-range-picker__editor"
                            ...
                            <span class="m-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                                <m-input
                                    size="small"
                                    class="m-date-range-picker__editor"
                                    :disabled="rangeState.selecting"
                    ...
                    <div class="m-picker-panel__content m-date-range-picker__content is-left">
                        <div class="m-date-range-picker__header">
                        <button
                            type="button"
                            @click="leftPrevYear"
                            class="m-picker-panel__icon-btn m-icon-doubleleft"></button>
                        <button
                            type="button"
                            @click="leftPrevMonth"
                            class="m-picker-panel__icon-btn m-icon-left"></button>
                        <button
                            type="button"
                            @click="leftNextYear"
                            v-if="unlinkPanels"
                            ...
                            class="m-picker-panel__icon-btn m-icon-doubleright"></button>
                        <button
                            type="button"
                            @click="leftNextMonth"
                            v-if="unlinkPanels"
                            ...
                            class="m-picker-panel__icon-btn m-icon-right"></button>
                        <div>{{ leftLabel }}</div>
                        </div>
                        <date-table
                    ...
                    <div class="m-picker-panel__content m-date-range-picker__content is-right">
                        <div class="m-date-range-picker__header">
                        <button
                            type="button"
                            @click="rightPrevYear"
            ...
            <div class="m-picker-panel__footer" v-if="showTime">
                <m-button
                    size="mini"
                    type="text"
                    class="m-picker-panel__link-btn"
                    @click="handleClear">
...
import {
    ...
    extractDateFormat,
    extractTimeFormat
} from 'melody-ui/src/utils/date-util'
...
export default {
    ...
    components: { TimePicker, DateTable, MInput, MButton }
}
</script>
