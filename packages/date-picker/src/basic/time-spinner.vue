<template>
    <div class="m-time-spinner" :class="{ 'has-seconds': showSeconds }">
        <template v-if="!arrowControl">
            <m-scrollbar
                @mouseenter.native="emitSelectRange('hours')"
                @mousemove.native="adjustCurrentSpinner('hours')"
                class="m-time-spinner__wrapper"
                wrap-style="max-height: inherit;"
                view-class="m-time-spinner__list"
                noresize
                tag="ul"
                ref="hours">
                <li
        ...
        <template v-if="arrowControl">
            <div
                ...
                class="m-time-spinner__wrapper is-arrow">
                <i v-repeat-click="decrease" class="m-time-spinner__arrow m-icon-up"></i>
                <i v-repeat-click="increase" class="m-time-spinner__arrow m-icon-down"></i>
                <ul class="m-time-spinner__list" ref="hours">
                    <li
                        class="m-time-spinner__item"
            ...
            <div
                ...
                <i v-repeat-click="decrease" class="m-time-spinner__arrow m-icon-up"></i>
                <i v-repeat-click="increase" class="m-time-spinner__arrow m-icon-down"></i>
                <ul class="m-time-spinner__list" ref="minutes">
                    <li
                        class="m-time-spinner__item"
            ...
            <div
                ...
                <i v-repeat-click="decrease" class="m-time-spinner__arrow m-icon-up"></i>
                <i v-repeat-click="increase" class="m-time-spinner__arrow m-icon-down"></i>
                <ul class="m-time-spinner__list" ref="seconds">
                    <li
...
import { getRangeHours, getRangeMinutes, modifyTime } from 'melody-ui/src/utils/date-util'
import MScrollbar from 'melody-ui/packages/scrollbar'
import RepeatClick from 'melody-ui/src/directives/repeat-click'
