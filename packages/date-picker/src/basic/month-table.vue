<template>
    <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="m-month-table">
        <tbody>
...
import { isDate, range, getDayCountOfMonth, nextDate } from 'melody-ui/src/utils/date-util'
import { hasClass } from 'melody-ui/src/utils/dom'
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'melody-ui/src/utils/util'
