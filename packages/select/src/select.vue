    ...
    <div
        ...
        <m-input
            ...
            <template slot="suffix">
                <i v-show="!showClose" :class="['m-select__caret', 'm-input__icon', 'm-icon-' + iconClass]"></i>
                <i v-if="showClose" class="m-select__caret m-input__icon m-icon-close-circle" @click="handleClearClick"></i>
            </template>
        </m-input>
        <transition
            name="m-zoom-in-top"
...
import { addResizeListener, removeResizeListener } from 'melody-ui/src/utils/resize-event'
import { t } from 'melody-ui/src/locale'
import scrollIntoView from 'melody-ui/src/utils/scroll-into-view'
import { getValueByPath, valueEquals, isIE, isEdge } from 'melody-ui/src/utils/util'
...
export default {
    ...
    watch: {
        ...
        placeholder(val) {
            this.currentPlaceholder = this.currentPlaceholder = val
        },
        value(val, oldVal) {
            if (this.multiple) {
                this.resetInputHeight()
