<template>
    <div
        ...
        :class="[
            ...
            status ? 'is-' + status : '',
            {
                'm-progress--without-text': !showText,
                'm-progress--text-inside': textInside
            }
        ]"
        role="progressbar"
        ...
        <div class="m-progress-bar" v-if="type === 'line'">
            <div class="m-progress-bar__outer" :style="{height: strokeWidth + 'px'}">
...
export default {
    ...
    computed: {
        ...
        iconClass() {
            ...
            if (this.type === 'line') {
                return this.status === 'success' ? 'm-icon-check-circle' : 'm-icon-close-circle'
            } else {
                return this.status === 'success' ? 'm-icon-check' : 'm-icon-close'
            }
        },
        progressTextSize() {
